...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Product chocolate2 = new Product(3, "chocolate", BigDecimal.valueOf(3.0), ProductCategory.FOOD, LocalDate.now().plusDays(1));
        ...
        Entry<Integer, Double> fantasticoExpiryPolicy = Map.entry(2, 0.5);
        ...
        fantastico.processClients(Arrays.asList(client1, client2));
